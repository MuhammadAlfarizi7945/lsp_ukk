        ...
        <div class="container-fluid">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6">
                        <div class="float-right d-none d-md-block">
                            <a class="btn btn-primary" type="button" href="<?= base_url(); ?>kategori"><i class="fas fa-angle-left mr-2"></i> Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="mt-0 header-title">Edit Data Kategori</h4>
                            ...
                            <form action="" method="post" id="form_advanced_validation">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="nama_kat" id="nama_kat" type="text" value="<?= $kat['nama_kat']; ?>" />
                                    </div>
                                </div>
