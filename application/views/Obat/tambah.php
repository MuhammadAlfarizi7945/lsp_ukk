                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" id="form_advanced_validation">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="kode_obat" id="kode_obat" type="text" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                        ...
                                        <select name="id_dist" class="form-control">
                                            ...
                                            <?php foreach ($dist as $dist) : ?>
                                                <option value="<?= $dist['id_dist']; ?>">
                                                    ID <?= $dist['id_dist']; ?> | <?= $dist['nama_dist']; ?> | <?= $dist['alamat']; ?> | <?= $dist['no_telp']; ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="masa_exfire" id="masa_exfire" type="text" />
                                    </div>
                                </div>
                                <div class="form-group row">
